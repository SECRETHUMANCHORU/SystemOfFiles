  ...
  setInterval(async() => {
    ...
    if (day != day_now) {
      ...
      checkttData.forEach(async(checkttFile) => {
        ...
        api.sendMessage(checkttBody, checkttFile.replace('.json', ''), (err) => err ? logger(err) : '');
...
(async function () {
    ...
    try {
        ...
        return logger(global.getText('listen', 'failLoadEnvironment', error), 'error');
    }
}());
